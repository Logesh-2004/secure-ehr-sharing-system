...
class AppTheme {
  ...
  static const Color primary = Color(0xFF165D8C);
  static const Color primaryDark = Color(0xFF0C3551);
  static const Color accent = Color(0xFF0F9D8A);
  static const Color accentSoft = Color(0xFFD9F5EF);
  static const Color danger = Color(0xFFD96464);
  static const Color background = Color(0xFFF4FAFC);
  static const Color surface = Colors.white;
  static const Color ink = Color(0xFF17313F);
  static const Color muted = Color(0xFF5F7682);
